        ...
        <form onSubmit={signupSubmitHandler} className='text-sm flex flex-col gap-4'>
            ...
            <div className='flex w-full gap-3'>
                <div className='flex-1 flex flex-col gap-1'>
                    ...
                    <input required name='firstName' value={formData.firstName} onChange={changeHandler} className='bg-(--richblack-800) w-full rounded-lg p-3' type="text" id="firstName" placeholder='Enter First Name'/>

                </div>
                <div className='flex-1  flex flex-col gap-1'>
                    <label htmlFor="lastName">Last Name<span className='text-red-400'>*</span></label>
                    <input required name='lastName' value={formData.lastName} onChange={changeHandler} className='bg-(--richblack-800) w-full rounded-lg p-3' type="text" id="lastName" placeholder='Enter Last Name'/>
                </div>
            </div>
            ...
            <div className='flex gap-3'>
                <div className='flex-1  flex flex-col gap-1'>
                    ...
                    <div className='relative flex items-center'>
                        <input required name='createPass' value={formData.createPass} onChange={changeHandler} className='bg-(--richblack-800) w-full rounded-lg p-3' type={`${showCreatePass? "text" : "password"}`} id="password" placeholder='Enter Password'/>
                ...
                <div className='flex-1 flex flex-col gap-1'>
                    ...
                    <div className='relative flex items-center'>
                        <input required name='confirmPass' value={formData.confirmPass} onChange={changeHandler} className='bg-(--richblack-800) w-full rounded-lg p-3' type={`${showConfirmPass? "text" : "password"}`} id="confirmedPassword" placeholder='Confirm Password'/>
